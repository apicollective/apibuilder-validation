 ...
 * apidoc:0.11.37 http://www.apidoc.me/flow/api/0.1.60/play_2_x_standalone_json
 */
  ...
  package object json {
    ...
    implicit def jsonReadsApiRefund: play.api.libs.json.Reads[Refund] = {
      (
        ...
        (__ \ "amount").read[BigDecimal] and
        (__ \ "currency").read[String] and
        (__ \ "captures").read[Seq[io.flow.v0.models.RefundCapture]]
      )(Refund.apply _)
    }
    ...
    implicit def jsonReadsApiRefundUpserted: play.api.libs.json.Reads[RefundUpserted] = {
      (
        ...
        (__ \ "amount").read[BigDecimal] and
        (__ \ "currency").read[String] and
        (__ \ "captures").read[Seq[_root_.play.api.libs.json.JsObject]]
