 ...
 * apidoc:0.11.37 http://www.apidoc.me/flow/api/0.1.54/play_2_x_standalone_json
 */
package io.flow.v0.models {
  ...
  object EventType {
     ...
     * above.
     */
    val all = Seq(CatalogUpserted, CatalogDeleted, SubcatalogUpserted, SubcatalogDeleted, CatalogItemUpserted, CatalogItemDeleted, SubcatalogItemUpserted, SubcatalogItemDeleted, FlowCurrencySettingDeleted, FlowCurrencySettingUpserted, RateDeleted, RateUpserted, SpotRateDeleted, SpotRateUpserted, OrganizationCurrencySettingDeleted, OrganizationCurrencySettingUpserted, ContractedRateUpserted, ExperienceDeleted, ExperienceUpserted, ItemMarginDeleted, ItemMarginUpserted, Hs6CodeUpserted, Hs6CodeDeleted, Hs10CodeUpserted, Hs10CodeDeleted, LocalizedItemUpserted, LocalizedItemDeleted, LocalizedItemSnapshot, OrganizationUpserted, OrganizationDeleted, TrackingLabelEventUpserted)
...
package io.flow.v0.models {
  ...
  package object json {
    ...
    def jsObjectCatalogItemExportType(obj: io.flow.v0.models.CatalogItemExportType) = {
      play.api.libs.json.Json.obj(
        "sort" -> play.api.libs.json.JsString(obj.sort)
      ) ++ (obj.numbers match {
        case None => play.api.libs.json.Json.obj()
