 ...
 * apidoc:0.11.37 http://www.apidoc.me/flow/api/0.1.63/play_2_x_standalone_json
 */
package io.flow.v0.models {
   ...
   * completed. A common pattern would be to request delivery of the export via email
   * - you will then receive an email notification once the requested export is ready
   */
  sealed trait ExportDelivery
  ...
  case class AuthorizationDeleted(
    eventId: String,
    timestamp: _root_.org.joda.time.DateTime,
    organization: String,
    key: String
  ...
  case class AuthorizationUpserted(
    eventId: String,
    timestamp: _root_.org.joda.time.DateTime,
    organization: String,
    key: String,
    orderNumber: _root_.scala.Option[String] = None,
    card: _root_.play.api.libs.json.JsObject,
    amount: BigDecimal,
    currency: String,
    customer: _root_.play.api.libs.json.JsObject,
    attributes: Map[String, String],
    destination: _root_.scala.Option[_root_.play.api.libs.json.JsObject] = None,
    result: _root_.play.api.libs.json.JsObject,
    ip: _root_.scala.Option[String] = None,
    createdAt: _root_.org.joda.time.DateTime
  ) extends Event
  ...
  case class CardUpserted(
    eventId: String,
    timestamp: _root_.org.joda.time.DateTime,
    organization: String,
    token: String,
    `type`: String,
    expiration: _root_.play.api.libs.json.JsObject,
    last4: String,
    name: String,
  ...
  case class Delivery(
    id: String,
    items: Seq[io.flow.v0.models.LineItemForm],
    options: Seq[io.flow.v0.models.DeliveryOption]
  )

  case class DeliveryEstimate(
    items: Seq[io.flow.v0.models.LineItemForm],
    options: Seq[io.flow.v0.models.DeliveryOptionEstimate]
  )
  ...
  case class DeliveryOptionEstimate(
    cost: io.flow.v0.models.Price,
    deliveredDuty: io.flow.v0.models.DeliveredDuty,
    price: io.flow.v0.models.Price,
    service: io.flow.v0.models.ServiceSummary,
  ...
  /**
   * Exports represent data extraction requests (e.g. download my catalog items to a
   * CSV file)
   */
  case class Export(
    id: String,
    `type`: io.flow.v0.models.ExportType,
    status: io.flow.v0.models.ExportStatus,
    createdAt: _root_.org.joda.time.DateTime,
    ...
    deliveries: Seq[io.flow.v0.models.ExportDelivery]
  )

  /**
   * Triggers an email notification once the requested export is ready
   */
  case class ExportDeliveryEmail(
    email: String
  ) extends ExportDelivery
   ...
   */
  case class ExportForm(
    `type`: io.flow.v0.models.ExportType,
    emails: _root_.scala.Option[Seq[String]] = None
  )

  case class ExportVersion(
    id: String,
    timestamp: _root_.org.joda.time.DateTime,
    `type`: io.flow.v0.models.ChangeType,
    export: io.flow.v0.models.Export
  )
  ...
  case class LabelUpserted(
    ...
    data: String,
    destination: _root_.play.api.libs.json.JsObject,
    origin: _root_.play.api.libs.json.JsObject,
    carrier: String,
    service: String,
    commercialInvoice: _root_.scala.Option[String] = None,
    pdf: _root_.scala.Option[String] = None,
    png: _root_.scala.Option[String] = None,
    order: _root_.scala.Option[String] = None
  ) extends Event
  ...
  case class LocalizedItemSnapshot(
    eventId: String,
    timestamp: _root_.org.joda.time.DateTime,
    organization: String,
    subcatalogId: String,
  ...
  case class OrderBookingDeleted(
    eventId: String,
    timestamp: _root_.org.joda.time.DateTime,
    organization: String,
    orderNumber: String
  ...
  case class OrderBookingUpserted(
    eventId: String,
    timestamp: _root_.org.joda.time.DateTime,
    organization: String,
    orderNumber: String
   ...
   * duties.
   */
  case class OrderEstimate(
    items: Seq[io.flow.v0.models.LocalizedLineItem],
    destination: io.flow.v0.models.Address,
    deliveries: Seq[io.flow.v0.models.DeliveryEstimate],
    prices: Seq[io.flow.v0.models.LocalizedPrice],
    total: io.flow.v0.models.LocalizedPrice
  )
  ...
  case class OrderPriceDetail(
    key: io.flow.v0.models.OrderPriceDetailKey,
    currency: String,
    amount: Double,
    label: String,
    components: Seq[io.flow.v0.models.OrderPriceDetailComponent]
  )

  case class OrderPriceDetailComponent(
    key: io.flow.v0.models.OrderPriceDetailComponentKey,
    currency: String,
    amount: Double,
    label: String,
    base: io.flow.v0.models.Price
   ...
   */
  case class OrderPriceDetails(
    subtotal: io.flow.v0.models.OrderPriceDetail,
    vat: io.flow.v0.models.OrderPriceDetail,
    duty: io.flow.v0.models.OrderPriceDetail,
    shipping: io.flow.v0.models.OrderPriceDetail,
    insurance: io.flow.v0.models.OrderPriceDetail,
    discounts: io.flow.v0.models.OrderPriceDetail,
    adjustments: io.flow.v0.models.OrderPriceDetail,
    total: io.flow.v0.models.PriceWithBase
  )
  ...
  case class OrderUpserted(
    ...
    customer: _root_.play.api.libs.json.JsObject,
    selections: Seq[String],
    items: Seq[_root_.play.api.libs.json.JsObject],
    destination: _root_.play.api.libs.json.JsObject,
    deliveries: Seq[_root_.play.api.libs.json.JsObject],
    prices: Seq[_root_.play.api.libs.json.JsObject],
    discount: _root_.scala.Option[_root_.play.api.libs.json.JsObject] = None,
    total: _root_.play.api.libs.json.JsObject
  ) extends Event
  ...
  case class QuoteEstimate(
    destination: io.flow.v0.models.Address,
    deliveries: Seq[io.flow.v0.models.DeliveryEstimate]
  )

  case class QuoteEstimateForm(
    destination: io.flow.v0.models.Address,
    experience: String,
    items: Seq[io.flow.v0.models.LineItemForm]
  )
  ...
  case class Refund(
    ...
    amount: BigDecimal,
    currency: String,
    captures: Seq[io.flow.v0.models.RefundCapture],
    createdAt: _root_.org.joda.time.DateTime
  )
   ...
   * refund you can specify either an authorization id or a capture id (or both as
   * long as they match).
   */
  ...
  case class RefundUpserted(
    ...
    amount: BigDecimal,
    currency: String,
    captures: Seq[_root_.play.api.libs.json.JsObject],
    createdAt: _root_.org.joda.time.DateTime
  ) extends Event
  ...
  case class ShippingLabel(
    ...
    pdf: _root_.scala.Option[String] = None,
    png: _root_.scala.Option[String] = None,
    order: _root_.scala.Option[io.flow.v0.models.LabelOrderSummary] = None
  )
   ...
   */
  case class SolidusProductExportType(
    numbers: _root_.scala.Option[Seq[String]] = None,
    sort: _root_.scala.Option[String] = None
  ) extends ExportType
   ...
   */
  case class SolidusVariantExportType(
    numbers: _root_.scala.Option[Seq[String]] = None,
    sort: _root_.scala.Option[String] = None
  ) extends ExportType
  ...
  case class WebhookDelivery(
    ...
    status: io.flow.v0.models.WebhookStatus,
    createdAt: _root_.org.joda.time.DateTime,
    latest: _root_.scala.Option[io.flow.v0.models.WebhookRequest] = None,
    nextAttemptAt: _root_.scala.Option[_root_.org.joda.time.DateTime] = None
  )
  ...
  case class WebhookSettings(
    secret: _root_.scala.Option[String] = None,
    retryMaxAttempts: Long = 6,
    retrySleepMs: Long = 60000,
    sleepMs: Long = 0
  )
  ...
  /**
   * Provides future compatibility in clients - in the future, when a type is added
   * to the union ExportDelivery, it will need to be handled in the client code. This
   * implementation will deserialize these future types as an instance of this class.
   */
  case class ExportDeliveryUndefinedType(
    description: String
  ) extends ExportDelivery

  /**
   * Provides future compatibility in clients - in the future, when a type is added
   * to the union ExportType, it will need to be handled in the client code. This
   * implementation will deserialize these future types as an instance of this class.
   */
  case class ExportTypeUndefinedType(
    description: String
  ) extends ExportType
  ...
  object EventType {
    ...
    case object OrderDeleted extends EventType { override def toString = "order_deleted" }
    case object OrderUpserted extends EventType { override def toString = "order_upserted" }
    case object OrderBookingDeleted extends EventType { override def toString = "order_booking_deleted" }
    case object OrderBookingUpserted extends EventType { override def toString = "order_booking_upserted" }
    ...
    case object LabelUpserted extends EventType { override def toString = "label_upserted" }
    ...
    case object LocalizedItemSnapshot extends EventType { override def toString = "localized_item_snapshot" }
    ...
    case object AuthorizationUpserted extends EventType { override def toString = "authorization_upserted" }
    case object AuthorizationDeleted extends EventType { override def toString = "authorization_deleted" }
    case object CaptureUpserted extends EventType { override def toString = "capture_upserted" }
    case object CardUpserted extends EventType { override def toString = "card_upserted" }
    case object CardDeleted extends EventType { override def toString = "card_deleted" }
    case object RefundUpserted extends EventType { override def toString = "refund_upserted" }
  ...
  /**
   * Export status is a finite state machine with valid transitions of created to
   * processing, processing to completed or failed
   */
  sealed trait ExportStatus

  object ExportStatus {

    case object Created extends ExportStatus { override def toString = "created" }
    case object Processing extends ExportStatus { override def toString = "processing" }
    case object Completed extends ExportStatus { override def toString = "completed" }
    case object Failed extends ExportStatus { override def toString = "failed" }
     ...
     * with the camel cased values above.
     */
    case class UNDEFINED(override val toString: String) extends ExportStatus
    ...
    def fromString(value: String): _root_.scala.Option[ExportStatus] = byName.get(value.toLowerCase)
  ...
  sealed trait OrderPriceDetailComponentKey
  ...
  object OrderPriceDetailComponentKey {
     ...
     */
    case object TaxDeminimus extends OrderPriceDetailComponentKey { override def toString = "tax_deminimus" }
    /**
     * An adjustment based on whether the duty deminimus applies to the order.
     */
    case object DutyDeminimus extends OrderPriceDetailComponentKey { override def toString = "duty_deminimus" }
    /**
  ...
  sealed trait OrderPriceDetailKey
  ...
  object WebhookStatus {
    ...
    case object Pending extends WebhookStatus { override def toString = "pending" }
    case object Success extends WebhookStatus { override def toString = "success" }
    case object Failure extends WebhookStatus { override def toString = "failure" }
     ...
     * with the camel cased values above.
     */
    case class UNDEFINED(override val toString: String) extends WebhookStatus
    ...
    def fromString(value: String): _root_.scala.Option[WebhookStatus] = byName.get(value.toLowerCase)
...
package io.flow.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsApiExportStatus = new play.api.libs.json.Reads[io.flow.v0.models.ExportStatus] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.v0.models.ExportStatus] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.v0.models.ExportStatus(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.v0.models.ExportStatus(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesApiExportStatus(obj: io.flow.v0.models.ExportStatus) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectExportStatus(obj: io.flow.v0.models.ExportStatus) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesApiExportStatus: play.api.libs.json.Writes[ExportStatus] = {
      new play.api.libs.json.Writes[io.flow.v0.models.ExportStatus] {
        def writes(obj: io.flow.v0.models.ExportStatus) = {
          jsonWritesApiExportStatus(obj)
        }
      }
    }
    ...
    implicit val jsonReadsApiOrderPriceDetailComponentKey = new play.api.libs.json.Reads[io.flow.v0.models.OrderPriceDetailComponentKey] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.v0.models.OrderPriceDetailComponentKey] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.v0.models.OrderPriceDetailComponentKey(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.v0.models.OrderPriceDetailComponentKey(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesApiOrderPriceDetailComponentKey(obj: io.flow.v0.models.OrderPriceDetailComponentKey) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectOrderPriceDetailComponentKey(obj: io.flow.v0.models.OrderPriceDetailComponentKey) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesApiOrderPriceDetailComponentKey: play.api.libs.json.Writes[OrderPriceDetailComponentKey] = {
      new play.api.libs.json.Writes[io.flow.v0.models.OrderPriceDetailComponentKey] {
        def writes(obj: io.flow.v0.models.OrderPriceDetailComponentKey) = {
          jsonWritesApiOrderPriceDetailComponentKey(obj)
        }
      }
    }

    implicit val jsonReadsApiOrderPriceDetailKey = new play.api.libs.json.Reads[io.flow.v0.models.OrderPriceDetailKey] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.v0.models.OrderPriceDetailKey] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.v0.models.OrderPriceDetailKey(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.v0.models.OrderPriceDetailKey(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesApiOrderPriceDetailKey(obj: io.flow.v0.models.OrderPriceDetailKey) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectOrderPriceDetailKey(obj: io.flow.v0.models.OrderPriceDetailKey) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesApiOrderPriceDetailKey: play.api.libs.json.Writes[OrderPriceDetailKey] = {
      new play.api.libs.json.Writes[io.flow.v0.models.OrderPriceDetailKey] {
        def writes(obj: io.flow.v0.models.OrderPriceDetailKey) = {
          jsonWritesApiOrderPriceDetailKey(obj)
        }
      }
    }
    ...
    implicit val jsonReadsApiWebhookStatus = new play.api.libs.json.Reads[io.flow.v0.models.WebhookStatus] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.v0.models.WebhookStatus] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.v0.models.WebhookStatus(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.v0.models.WebhookStatus(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesApiWebhookStatus(obj: io.flow.v0.models.WebhookStatus) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectWebhookStatus(obj: io.flow.v0.models.WebhookStatus) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesApiWebhookStatus: play.api.libs.json.Writes[WebhookStatus] = {
      new play.api.libs.json.Writes[io.flow.v0.models.WebhookStatus] {
        def writes(obj: io.flow.v0.models.WebhookStatus) = {
          jsonWritesApiWebhookStatus(obj)
        }
      }
    }
    ...
    implicit def jsonReadsApiAuthorization: play.api.libs.json.Reads[Authorization] = {
      (
        ...
        (__ \ "result").read[io.flow.v0.models.AuthorizationResult] and
    ...
    implicit def jsonReadsApiAuthorizationDeleted: play.api.libs.json.Reads[AuthorizationDeleted] = {
      (
        (__ \ "event_id").read[String] and
        (__ \ "timestamp").read[_root_.org.joda.time.DateTime] and
        (__ \ "organization").read[String] and
        (__ \ "key").read[String]
      )(AuthorizationDeleted.apply _)
    }

    def jsObjectAuthorizationDeleted(obj: io.flow.v0.models.AuthorizationDeleted) = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonReadsApiAuthorizationUpserted: play.api.libs.json.Reads[AuthorizationUpserted] = {
      (
        (__ \ "event_id").read[String] and
        (__ \ "timestamp").read[_root_.org.joda.time.DateTime] and
        (__ \ "organization").read[String] and
        (__ \ "key").read[String] and
        (__ \ "order_number").readNullable[String] and
        (__ \ "card").read[_root_.play.api.libs.json.JsObject] and
        (__ \ "amount").read[BigDecimal] and
        (__ \ "currency").read[String] and
        (__ \ "customer").read[_root_.play.api.libs.json.JsObject] and
        (__ \ "attributes").read[Map[String, String]] and
        (__ \ "destination").readNullable[_root_.play.api.libs.json.JsObject] and
        (__ \ "result").read[_root_.play.api.libs.json.JsObject] and
        (__ \ "ip").readNullable[String] and
        (__ \ "created_at").read[_root_.org.joda.time.DateTime]
      )(AuthorizationUpserted.apply _)
    }

    def jsObjectAuthorizationUpserted(obj: io.flow.v0.models.AuthorizationUpserted) = {
      play.api.libs.json.Json.obj(
        "event_id" -> play.api.libs.json.JsString(obj.eventId),
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "organization" -> play.api.libs.json.JsString(obj.organization),
      ...
      (obj.destination match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("destination" -> x)
      }) ++
      (obj.ip match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("ip" -> play.api.libs.json.JsString(x))
    ...
    implicit def jsonReadsApiCaptureUpserted: play.api.libs.json.Reads[CaptureUpserted] = {
      (
        (__ \ "event_id").read[String] and
        (__ \ "timestamp").read[_root_.org.joda.time.DateTime] and
        (__ \ "organization").read[String] and
        (__ \ "key").read[String] and
        (__ \ "authorization_key").read[String] and
        (__ \ "amount").read[BigDecimal] and
        (__ \ "currency").read[String] and
        (__ \ "created_at").read[_root_.org.joda.time.DateTime]
      )(CaptureUpserted.apply _)
    }

    def jsObjectCaptureUpserted(obj: io.flow.v0.models.CaptureUpserted) = {
      play.api.libs.json.Json.obj(
        "event_id" -> play.api.libs.json.JsString(obj.eventId),
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "organization" -> play.api.libs.json.JsString(obj.organization),
    ...
    implicit def jsonReadsApiCardDeleted: play.api.libs.json.Reads[CardDeleted] = {
      (
        (__ \ "event_id").read[String] and
        (__ \ "timestamp").read[_root_.org.joda.time.DateTime] and
        (__ \ "organization").read[String] and
    ...
    def jsObjectCardDeleted(obj: io.flow.v0.models.CardDeleted) = {
      play.api.libs.json.Json.obj(
        "event_id" -> play.api.libs.json.JsString(obj.eventId),
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "organization" -> play.api.libs.json.JsString(obj.organization),
    ...
    implicit def jsonReadsApiCardUpserted: play.api.libs.json.Reads[CardUpserted] = {
      (
        (__ \ "event_id").read[String] and
        (__ \ "timestamp").read[_root_.org.joda.time.DateTime] and
        (__ \ "organization").read[String] and
        ...
        (__ \ "expiration").read[_root_.play.api.libs.json.JsObject] and
        (__ \ "last4").read[String] and
        (__ \ "name").read[String] and
        (__ \ "address").read[_root_.play.api.libs.json.JsObject]
      )(CardUpserted.apply _)
    }

    def jsObjectCardUpserted(obj: io.flow.v0.models.CardUpserted) = {
      play.api.libs.json.Json.obj(
        "event_id" -> play.api.libs.json.JsString(obj.eventId),
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "organization" -> play.api.libs.json.JsString(obj.organization),
    ...
    implicit def jsonReadsApiCatalogItemExportType: play.api.libs.json.Reads[CatalogItemExportType] = {
      (
        (__ \ "numbers").readNullable[Seq[String]] and
        (__ \ "q").readNullable[String] and
        (__ \ "sort").readNullable[String]
      )(CatalogItemExportType.apply _)
    }

    def jsObjectCatalogItemExportType(obj: io.flow.v0.models.CatalogItemExportType) = {
      (obj.numbers match {
        case None => play.api.libs.json.Json.obj()
      ...
      (obj.sort match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("sort" -> play.api.libs.json.JsString(x))
      })
    }
    ...
    implicit def jsonReadsApiDelivery: play.api.libs.json.Reads[Delivery] = {
      (
        (__ \ "id").read[String] and
        (__ \ "items").read[Seq[io.flow.v0.models.LineItemForm]] and
    ...
    implicit def jsonReadsApiDeliveryEstimate: play.api.libs.json.Reads[DeliveryEstimate] = {
      (
        (__ \ "items").read[Seq[io.flow.v0.models.LineItemForm]] and
        (__ \ "options").read[Seq[io.flow.v0.models.DeliveryOptionEstimate]]
      )(DeliveryEstimate.apply _)
    }

    def jsObjectDeliveryEstimate(obj: io.flow.v0.models.DeliveryEstimate) = {
      play.api.libs.json.Json.obj(
        "items" -> play.api.libs.json.Json.toJson(obj.items),
        "options" -> play.api.libs.json.Json.toJson(obj.options)
      )
    ...
    implicit def jsonWritesApiDeliveryEstimate: play.api.libs.json.Writes[DeliveryEstimate] = {
      new play.api.libs.json.Writes[io.flow.v0.models.DeliveryEstimate] {
        def writes(obj: io.flow.v0.models.DeliveryEstimate) = {
          jsObjectDeliveryEstimate(obj)
        }
      }
    }
    ...
    implicit def jsonReadsApiDeliveryOptionEstimate: play.api.libs.json.Reads[DeliveryOptionEstimate] = {
      (
        (__ \ "cost").read[io.flow.v0.models.Price] and
        (__ \ "delivered_duty").read[io.flow.v0.models.DeliveredDuty] and
        (__ \ "price").read[io.flow.v0.models.Price] and
        ...
        (__ \ "tier").read[io.flow.v0.models.TierSummary] and
        (__ \ "window").read[io.flow.v0.models.DatetimeRange]
      )(DeliveryOptionEstimate.apply _)
    }

    def jsObjectDeliveryOptionEstimate(obj: io.flow.v0.models.DeliveryOptionEstimate) = {
      play.api.libs.json.Json.obj(
        "cost" -> jsObjectPrice(obj.cost),
        "delivered_duty" -> play.api.libs.json.JsString(obj.deliveredDuty.toString),
        "price" -> jsObjectPrice(obj.price),
    ...
    implicit def jsonWritesApiDeliveryOptionEstimate: play.api.libs.json.Writes[DeliveryOptionEstimate] = {
      new play.api.libs.json.Writes[io.flow.v0.models.DeliveryOptionEstimate] {
        def writes(obj: io.flow.v0.models.DeliveryOptionEstimate) = {
          jsObjectDeliveryOptionEstimate(obj)
        }
      }
    }
    ...
    implicit def jsonReadsApiDeliverySummary: play.api.libs.json.Reads[DeliverySummary] = {
      (
        (__ \ "id").read[String] and
        (__ \ "items").read[Seq[io.flow.v0.models.LineItemForm]]
    ...
    implicit def jsonReadsApiExport: play.api.libs.json.Reads[Export] = {
      (
        (__ \ "id").read[String] and
        (__ \ "type").read[io.flow.v0.models.ExportType] and
        (__ \ "status").read[io.flow.v0.models.ExportStatus] and
        ...
        (__ \ "deliveries").read[Seq[io.flow.v0.models.ExportDelivery]]
      )(Export.apply _)
    }

    def jsObjectExport(obj: io.flow.v0.models.Export) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        "type" -> jsObjectExportType(obj.`type`),
        "status" -> play.api.libs.json.JsString(obj.status.toString),
        "created_at" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.createdAt)),
    ...
    implicit def jsonWritesApiExport: play.api.libs.json.Writes[Export] = {
      new play.api.libs.json.Writes[io.flow.v0.models.Export] {
        def writes(obj: io.flow.v0.models.Export) = {
          jsObjectExport(obj)
        }
      }
    }

    implicit def jsonReadsApiExportDeliveryEmail: play.api.libs.json.Reads[ExportDeliveryEmail] = {
      (__ \ "email").read[String].map { x => new ExportDeliveryEmail(email = x) }
    }

    def jsObjectExportDeliveryEmail(obj: io.flow.v0.models.ExportDeliveryEmail) = {
      play.api.libs.json.Json.obj(
        "email" -> play.api.libs.json.JsString(obj.email)
      )
    }

    implicit def jsonReadsApiExportForm: play.api.libs.json.Reads[ExportForm] = {
      (
        (__ \ "type").read[io.flow.v0.models.ExportType] and
        (__ \ "emails").readNullable[Seq[String]]
      )(ExportForm.apply _)
    }

    def jsObjectExportForm(obj: io.flow.v0.models.ExportForm) = {
      play.api.libs.json.Json.obj(
        "type" -> jsObjectExportType(obj.`type`)
      ) ++ (obj.emails match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("emails" -> play.api.libs.json.Json.toJson(x))
      })
    }

    implicit def jsonWritesApiExportForm: play.api.libs.json.Writes[ExportForm] = {
      new play.api.libs.json.Writes[io.flow.v0.models.ExportForm] {
        def writes(obj: io.flow.v0.models.ExportForm) = {
          jsObjectExportForm(obj)
        }
      }
    }

    implicit def jsonReadsApiExportVersion: play.api.libs.json.Reads[ExportVersion] = {
      (
        (__ \ "id").read[String] and
        (__ \ "timestamp").read[_root_.org.joda.time.DateTime] and
        (__ \ "type").read[io.flow.v0.models.ChangeType] and
        (__ \ "export").read[io.flow.v0.models.Export]
      )(ExportVersion.apply _)
    }

    def jsObjectExportVersion(obj: io.flow.v0.models.ExportVersion) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "type" -> play.api.libs.json.JsString(obj.`type`.toString),
        "export" -> jsObjectExport(obj.export)
      )
    }

    implicit def jsonWritesApiExportVersion: play.api.libs.json.Writes[ExportVersion] = {
      new play.api.libs.json.Writes[io.flow.v0.models.ExportVersion] {
        def writes(obj: io.flow.v0.models.ExportVersion) = {
          jsObjectExportVersion(obj)
        }
      }
    }
    ...
    implicit def jsonReadsApiLabelOrderSummary: play.api.libs.json.Reads[LabelOrderSummary] = {
      (
        (__ \ "id").read[String] and
        (__ \ "number").read[String]
      )(LabelOrderSummary.apply _)
    }

    def jsObjectLabelOrderSummary(obj: io.flow.v0.models.LabelOrderSummary) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        "number" -> play.api.libs.json.JsString(obj.number)
      )
    ...
    implicit def jsonWritesApiLabelOrderSummary: play.api.libs.json.Writes[LabelOrderSummary] = {
      new play.api.libs.json.Writes[io.flow.v0.models.LabelOrderSummary] {
        def writes(obj: io.flow.v0.models.LabelOrderSummary) = {
          jsObjectLabelOrderSummary(obj)
        }
      }
    }
    ...
    implicit def jsonReadsApiLabelUpserted: play.api.libs.json.Reads[LabelUpserted] = {
      (
        (__ \ "event_id").read[String] and
        (__ \ "timestamp").read[_root_.org.joda.time.DateTime] and
        (__ \ "organization").read[String] and
        ...
        (__ \ "destination").read[_root_.play.api.libs.json.JsObject] and
        (__ \ "origin").read[_root_.play.api.libs.json.JsObject] and
        (__ \ "carrier").read[String] and
        (__ \ "service").read[String] and
        (__ \ "commercial_invoice").readNullable[String] and
        (__ \ "pdf").readNullable[String] and
        (__ \ "png").readNullable[String] and
        (__ \ "order").readNullable[String]
      )(LabelUpserted.apply _)
    }

    def jsObjectLabelUpserted(obj: io.flow.v0.models.LabelUpserted) = {
      play.api.libs.json.Json.obj(
        "event_id" -> play.api.libs.json.JsString(obj.eventId),
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "organization" -> play.api.libs.json.JsString(obj.organization),
      ...
      (obj.order match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("order" -> play.api.libs.json.JsString(x))
      })
    }
    ...
    implicit def jsonReadsApiLineItem: play.api.libs.json.Reads[LineItem] = {
      (
        (__ \ "number").read[String] and
        (__ \ "quantity").read[Long] and
        (__ \ "price").read[io.flow.v0.models.Money] and
        (__ \ "attributes").read[Map[String, String]] and
    ...
    implicit def jsonReadsApiLineItemForm: play.api.libs.json.Reads[LineItemForm] = {
      (
        (__ \ "number").read[String] and
        (__ \ "quantity").read[Long] and
    ...
    def jsObjectLineItemForm(obj: io.flow.v0.models.LineItemForm) = {
      play.api.libs.json.Json.obj(
        "number" -> play.api.libs.json.JsString(obj.number),
        "quantity" -> play.api.libs.json.JsNumber(obj.quantity)
      ) ++ (obj.price match {
    ...
    implicit def jsonWritesApiLineItemForm: play.api.libs.json.Writes[LineItemForm] = {
      new play.api.libs.json.Writes[io.flow.v0.models.LineItemForm] {
        def writes(obj: io.flow.v0.models.LineItemForm) = {
    ...
    implicit def jsonReadsApiLocalizedItemSnapshot: play.api.libs.json.Reads[LocalizedItemSnapshot] = {
      (
        (__ \ "event_id").read[String] and
        (__ \ "timestamp").read[_root_.org.joda.time.DateTime] and
        (__ \ "organization").read[String] and
        (__ \ "subcatalog_id").read[String] and
        (__ \ "url").read[String]
      )(LocalizedItemSnapshot.apply _)
    }

    def jsObjectLocalizedItemSnapshot(obj: io.flow.v0.models.LocalizedItemSnapshot) = {
      play.api.libs.json.Json.obj(
        "event_id" -> play.api.libs.json.JsString(obj.eventId),
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "organization" -> play.api.libs.json.JsString(obj.organization),
    ...
    implicit def jsonReadsApiOrder: play.api.libs.json.Reads[Order] = {
      (
        ...
        (__ \ "prices").read[Seq[io.flow.v0.models.LocalizedPrice]] and
        (__ \ "total").read[io.flow.v0.models.LocalizedPrice] and
        (__ \ "attributes").read[Map[String, String]]
      )(Order.apply _)
    }
    ...
    implicit def jsonReadsApiOrderBookingDeleted: play.api.libs.json.Reads[OrderBookingDeleted] = {
      (
        (__ \ "event_id").read[String] and
        (__ \ "timestamp").read[_root_.org.joda.time.DateTime] and
        (__ \ "organization").read[String] and
        (__ \ "order_number").read[String]
      )(OrderBookingDeleted.apply _)
    }

    def jsObjectOrderBookingDeleted(obj: io.flow.v0.models.OrderBookingDeleted) = {
      play.api.libs.json.Json.obj(
        "event_id" -> play.api.libs.json.JsString(obj.eventId),
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "organization" -> play.api.libs.json.JsString(obj.organization),
    ...
    implicit def jsonReadsApiOrderBookingUpserted: play.api.libs.json.Reads[OrderBookingUpserted] = {
      (
        (__ \ "event_id").read[String] and
        (__ \ "timestamp").read[_root_.org.joda.time.DateTime] and
        (__ \ "organization").read[String] and
        (__ \ "order_number").read[String]
      )(OrderBookingUpserted.apply _)
    }

    def jsObjectOrderBookingUpserted(obj: io.flow.v0.models.OrderBookingUpserted) = {
      play.api.libs.json.Json.obj(
        "event_id" -> play.api.libs.json.JsString(obj.eventId),
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "organization" -> play.api.libs.json.JsString(obj.organization),
    ...
    implicit def jsonReadsApiOrderDeleted: play.api.libs.json.Reads[OrderDeleted] = {
      (
        (__ \ "event_id").read[String] and
        (__ \ "timestamp").read[_root_.org.joda.time.DateTime] and
        (__ \ "organization").read[String] and
        (__ \ "number").read[String]
      )(OrderDeleted.apply _)
    }

    def jsObjectOrderDeleted(obj: io.flow.v0.models.OrderDeleted) = {
      play.api.libs.json.Json.obj(
        "event_id" -> play.api.libs.json.JsString(obj.eventId),
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "organization" -> play.api.libs.json.JsString(obj.organization),
    ...
    implicit def jsonReadsApiOrderEstimate: play.api.libs.json.Reads[OrderEstimate] = {
      (
        (__ \ "items").read[Seq[io.flow.v0.models.LocalizedLineItem]] and
        (__ \ "destination").read[io.flow.v0.models.Address] and
        (__ \ "deliveries").read[Seq[io.flow.v0.models.DeliveryEstimate]] and
        (__ \ "prices").read[Seq[io.flow.v0.models.LocalizedPrice]] and
        (__ \ "total").read[io.flow.v0.models.LocalizedPrice]
      )(OrderEstimate.apply _)
    }

    def jsObjectOrderEstimate(obj: io.flow.v0.models.OrderEstimate) = {
      play.api.libs.json.Json.obj(
        "items" -> play.api.libs.json.Json.toJson(obj.items),
        "destination" -> jsObjectAddress(obj.destination),
        "deliveries" -> play.api.libs.json.Json.toJson(obj.deliveries),
    ...
    implicit def jsonWritesApiOrderEstimate: play.api.libs.json.Writes[OrderEstimate] = {
      new play.api.libs.json.Writes[io.flow.v0.models.OrderEstimate] {
        def writes(obj: io.flow.v0.models.OrderEstimate) = {
          jsObjectOrderEstimate(obj)
        }
      }
    }

    implicit def jsonReadsApiOrderEstimateForm: play.api.libs.json.Reads[OrderEstimateForm] = {
      (
        (__ \ "destination").read[io.flow.v0.models.Address] and
        (__ \ "items").read[Seq[io.flow.v0.models.LineItemForm]]
    ...
    def jsObjectOrderEstimateForm(obj: io.flow.v0.models.OrderEstimateForm) = {
      play.api.libs.json.Json.obj(
        "destination" -> jsObjectAddress(obj.destination),
        "items" -> play.api.libs.json.Json.toJson(obj.items)
      )
    ...
    implicit def jsonWritesApiOrderEstimateForm: play.api.libs.json.Writes[OrderEstimateForm] = {
      new play.api.libs.json.Writes[io.flow.v0.models.OrderEstimateForm] {
        def writes(obj: io.flow.v0.models.OrderEstimateForm) = {
    ...
    implicit def jsonReadsApiOrderPriceDetail: play.api.libs.json.Reads[OrderPriceDetail] = {
      (
        (__ \ "key").read[io.flow.v0.models.OrderPriceDetailKey] and
        (__ \ "currency").read[String] and
        (__ \ "amount").read[Double] and
        (__ \ "label").read[String] and
        (__ \ "components").read[Seq[io.flow.v0.models.OrderPriceDetailComponent]]
      )(OrderPriceDetail.apply _)
    }

    def jsObjectOrderPriceDetail(obj: io.flow.v0.models.OrderPriceDetail) = {
      play.api.libs.json.Json.obj(
        "key" -> play.api.libs.json.JsString(obj.key.toString),
        "currency" -> play.api.libs.json.JsString(obj.currency),
        "amount" -> play.api.libs.json.JsNumber(obj.amount),
    ...
    implicit def jsonWritesApiOrderPriceDetail: play.api.libs.json.Writes[OrderPriceDetail] = {
      new play.api.libs.json.Writes[io.flow.v0.models.OrderPriceDetail] {
        def writes(obj: io.flow.v0.models.OrderPriceDetail) = {
          jsObjectOrderPriceDetail(obj)
        }
      }
    }

    implicit def jsonReadsApiOrderPriceDetailComponent: play.api.libs.json.Reads[OrderPriceDetailComponent] = {
      (
        (__ \ "key").read[io.flow.v0.models.OrderPriceDetailComponentKey] and
        (__ \ "currency").read[String] and
        (__ \ "amount").read[Double] and
        (__ \ "label").read[String] and
        (__ \ "base").read[io.flow.v0.models.Price]
    ...
    def jsObjectOrderPriceDetailComponent(obj: io.flow.v0.models.OrderPriceDetailComponent) = {
      play.api.libs.json.Json.obj(
        "key" -> play.api.libs.json.JsString(obj.key.toString),
        "currency" -> play.api.libs.json.JsString(obj.currency),
        "amount" -> play.api.libs.json.JsNumber(obj.amount),
    ...
    implicit def jsonWritesApiOrderPriceDetailComponent: play.api.libs.json.Writes[OrderPriceDetailComponent] = {
      new play.api.libs.json.Writes[io.flow.v0.models.OrderPriceDetailComponent] {
        def writes(obj: io.flow.v0.models.OrderPriceDetailComponent) = {
          jsObjectOrderPriceDetailComponent(obj)
        }
      }
    }

    implicit def jsonReadsApiOrderPriceDetails: play.api.libs.json.Reads[OrderPriceDetails] = {
      (
        (__ \ "subtotal").read[io.flow.v0.models.OrderPriceDetail] and
        (__ \ "vat").read[io.flow.v0.models.OrderPriceDetail] and
        (__ \ "duty").read[io.flow.v0.models.OrderPriceDetail] and
        (__ \ "shipping").read[io.flow.v0.models.OrderPriceDetail] and
        (__ \ "insurance").read[io.flow.v0.models.OrderPriceDetail] and
        (__ \ "discounts").read[io.flow.v0.models.OrderPriceDetail] and
        (__ \ "adjustments").read[io.flow.v0.models.OrderPriceDetail] and
        (__ \ "total").read[io.flow.v0.models.PriceWithBase]
      )(OrderPriceDetails.apply _)
    }

    def jsObjectOrderPriceDetails(obj: io.flow.v0.models.OrderPriceDetails) = {
      play.api.libs.json.Json.obj(
        "subtotal" -> jsObjectOrderPriceDetail(obj.subtotal),
        "vat" -> jsObjectOrderPriceDetail(obj.vat),
        "duty" -> jsObjectOrderPriceDetail(obj.duty),
        "shipping" -> jsObjectOrderPriceDetail(obj.shipping),
        "insurance" -> jsObjectOrderPriceDetail(obj.insurance),
        "discounts" -> jsObjectOrderPriceDetail(obj.discounts),
        "adjustments" -> jsObjectOrderPriceDetail(obj.adjustments),
        "total" -> jsObjectPriceWithBase(obj.total)
      )
    }

    implicit def jsonWritesApiOrderPriceDetails: play.api.libs.json.Writes[OrderPriceDetails] = {
      new play.api.libs.json.Writes[io.flow.v0.models.OrderPriceDetails] {
        def writes(obj: io.flow.v0.models.OrderPriceDetails) = {
          jsObjectOrderPriceDetails(obj)
        }
      }
    }
    ...
    implicit def jsonReadsApiOrderUpserted: play.api.libs.json.Reads[OrderUpserted] = {
      (
        (__ \ "event_id").read[String] and
        (__ \ "timestamp").read[_root_.org.joda.time.DateTime] and
        (__ \ "organization").read[String] and
        ...
        (__ \ "experience_id").read[String] and
        (__ \ "expires_at").read[_root_.org.joda.time.DateTime] and
        (__ \ "customer").read[_root_.play.api.libs.json.JsObject] and
        (__ \ "selections").read[Seq[String]] and
        (__ \ "items").read[Seq[_root_.play.api.libs.json.JsObject]] and
        (__ \ "destination").read[_root_.play.api.libs.json.JsObject] and
        (__ \ "deliveries").read[Seq[_root_.play.api.libs.json.JsObject]] and
        (__ \ "prices").read[Seq[_root_.play.api.libs.json.JsObject]] and
        (__ \ "discount").readNullable[_root_.play.api.libs.json.JsObject] and
        (__ \ "total").read[_root_.play.api.libs.json.JsObject]
      )(OrderUpserted.apply _)
    }

    def jsObjectOrderUpserted(obj: io.flow.v0.models.OrderUpserted) = {
      play.api.libs.json.Json.obj(
        "event_id" -> play.api.libs.json.JsString(obj.eventId),
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "organization" -> play.api.libs.json.JsString(obj.organization),
        ...
        "experience_id" -> play.api.libs.json.JsString(obj.experienceId),
        "expires_at" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.expiresAt)),
        "customer" -> obj.customer,
        "selections" -> play.api.libs.json.Json.toJson(obj.selections),
        "items" -> play.api.libs.json.Json.toJson(obj.items),
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("discount" -> x)
      })
    }
    ...
    implicit def jsonReadsApiPriceWithBase: play.api.libs.json.Reads[PriceWithBase] = {
      (
        (__ \ "currency").read[String] and
        (__ \ "amount").read[Double] and
        (__ \ "label").read[String] and
    ...
    def jsObjectPriceWithBase(obj: io.flow.v0.models.PriceWithBase) = {
      play.api.libs.json.Json.obj(
        "currency" -> play.api.libs.json.JsString(obj.currency),
        "amount" -> play.api.libs.json.JsNumber(obj.amount),
        "label" -> play.api.libs.json.JsString(obj.label),
    ...
    implicit def jsonWritesApiPriceWithBase: play.api.libs.json.Writes[PriceWithBase] = {
      new play.api.libs.json.Writes[io.flow.v0.models.PriceWithBase] {
        def writes(obj: io.flow.v0.models.PriceWithBase) = {
    ...
    implicit def jsonReadsApiQuoteEstimate: play.api.libs.json.Reads[QuoteEstimate] = {
      (
        (__ \ "destination").read[io.flow.v0.models.Address] and
        (__ \ "deliveries").read[Seq[io.flow.v0.models.DeliveryEstimate]]
      )(QuoteEstimate.apply _)
    }

    def jsObjectQuoteEstimate(obj: io.flow.v0.models.QuoteEstimate) = {
      play.api.libs.json.Json.obj(
        "destination" -> jsObjectAddress(obj.destination),
        "deliveries" -> play.api.libs.json.Json.toJson(obj.deliveries)
      )
    ...
    implicit def jsonWritesApiQuoteEstimate: play.api.libs.json.Writes[QuoteEstimate] = {
      new play.api.libs.json.Writes[io.flow.v0.models.QuoteEstimate] {
        def writes(obj: io.flow.v0.models.QuoteEstimate) = {
          jsObjectQuoteEstimate(obj)
        }
      }
    }

    implicit def jsonReadsApiQuoteEstimateForm: play.api.libs.json.Reads[QuoteEstimateForm] = {
      (
        (__ \ "destination").read[io.flow.v0.models.Address] and
        (__ \ "experience").read[String] and
        (__ \ "items").read[Seq[io.flow.v0.models.LineItemForm]]
      )(QuoteEstimateForm.apply _)
    }

    def jsObjectQuoteEstimateForm(obj: io.flow.v0.models.QuoteEstimateForm) = {
      play.api.libs.json.Json.obj(
        "destination" -> jsObjectAddress(obj.destination),
    ...
    implicit def jsonWritesApiQuoteEstimateForm: play.api.libs.json.Writes[QuoteEstimateForm] = {
      new play.api.libs.json.Writes[io.flow.v0.models.QuoteEstimateForm] {
        def writes(obj: io.flow.v0.models.QuoteEstimateForm) = {
          jsObjectQuoteEstimateForm(obj)
        }
      }
    }
    ...
    implicit def jsonReadsApiRefund: play.api.libs.json.Reads[Refund] = {
      (
        ...
        (__ \ "amount").read[BigDecimal] and
        (__ \ "currency").read[String] and
        (__ \ "captures").read[Seq[io.flow.v0.models.RefundCapture]] and
        (__ \ "created_at").read[_root_.org.joda.time.DateTime]
      )(Refund.apply _)
    }
    ...
    implicit def jsonReadsApiRefundCapture: play.api.libs.json.Reads[RefundCapture] = {
      (
        (__ \ "capture").read[io.flow.v0.models.Capture] and
        (__ \ "amount").read[BigDecimal]
      )(RefundCapture.apply _)
    }

    def jsObjectRefundCapture(obj: io.flow.v0.models.RefundCapture) = {
      play.api.libs.json.Json.obj(
        "capture" -> jsObjectCapture(obj.capture),
        "amount" -> play.api.libs.json.JsNumber(obj.amount)
      )
    ...
    implicit def jsonWritesApiRefundCapture: play.api.libs.json.Writes[RefundCapture] = {
      new play.api.libs.json.Writes[io.flow.v0.models.RefundCapture] {
        def writes(obj: io.flow.v0.models.RefundCapture) = {
    ...
    implicit def jsonReadsApiRefundForm: play.api.libs.json.Reads[RefundForm] = {
      (
        (__ \ "authorization_id").readNullable[String] and
        (__ \ "capture_id").readNullable[String] and
        (__ \ "key").readNullable[String] and
        (__ \ "amount").readNullable[BigDecimal] and
        (__ \ "currency").readNullable[String]
      )(RefundForm.apply _)
    ...
    implicit def jsonReadsApiRefundUpserted: play.api.libs.json.Reads[RefundUpserted] = {
      (
        (__ \ "event_id").read[String] and
        (__ \ "timestamp").read[_root_.org.joda.time.DateTime] and
        (__ \ "organization").read[String] and
        ...
        (__ \ "amount").read[BigDecimal] and
        (__ \ "currency").read[String] and
        (__ \ "captures").read[Seq[_root_.play.api.libs.json.JsObject]] and
        (__ \ "created_at").read[_root_.org.joda.time.DateTime]
      )(RefundUpserted.apply _)
    }

    def jsObjectRefundUpserted(obj: io.flow.v0.models.RefundUpserted) = {
      play.api.libs.json.Json.obj(
        "event_id" -> play.api.libs.json.JsString(obj.eventId),
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "organization" -> play.api.libs.json.JsString(obj.organization),
    ...
    implicit def jsonReadsApiShippingLabel: play.api.libs.json.Reads[ShippingLabel] = {
      (
        ...
        (__ \ "pdf").readNullable[String] and
        (__ \ "png").readNullable[String] and
        (__ \ "order").readNullable[io.flow.v0.models.LabelOrderSummary]
    ...
    def jsObjectShippingLabel(obj: io.flow.v0.models.ShippingLabel) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        "carrier_tracking_number" -> play.api.libs.json.JsString(obj.carrierTrackingNumber),
        "zpl" -> play.api.libs.json.JsString(obj.zpl),
        "destination" -> jsObjectShippingAddress(obj.destination),
        "flow_tracking_number" -> play.api.libs.json.JsString(obj.flowTrackingNumber),
      ...
      (obj.order match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("order" -> jsObjectLabelOrderSummary(x))
      })
    }
    ...
    implicit def jsonReadsApiShippingLabelForm: play.api.libs.json.Reads[ShippingLabelForm] = {
      (
        ...
        (__ \ "insurance").readNullable[io.flow.v0.models.Price] and
        (__ \ "order_number").readNullable[String]
    ...
    implicit def jsonReadsApiSolidusProductExportType: play.api.libs.json.Reads[SolidusProductExportType] = {
      (
        (__ \ "numbers").readNullable[Seq[String]] and
        (__ \ "sort").readNullable[String]
      )(SolidusProductExportType.apply _)
    }

    def jsObjectSolidusProductExportType(obj: io.flow.v0.models.SolidusProductExportType) = {
      (obj.numbers match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("numbers" -> play.api.libs.json.Json.toJson(x))
      }) ++
    ...
    implicit def jsonReadsApiSolidusVariantExportType: play.api.libs.json.Reads[SolidusVariantExportType] = {
      (
        (__ \ "numbers").readNullable[Seq[String]] and
        (__ \ "sort").readNullable[String]
      )(SolidusVariantExportType.apply _)
    }

    def jsObjectSolidusVariantExportType(obj: io.flow.v0.models.SolidusVariantExportType) = {
      (obj.numbers match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("numbers" -> play.api.libs.json.Json.toJson(x))
      }) ++
    ...
    implicit def jsonReadsApiTracking: play.api.libs.json.Reads[Tracking] = {
      (
        (__ \ "id").read[String] and
        (__ \ "status").read[io.flow.v0.models.TrackingStatus] and
        (__ \ "metadata").read[_root_.play.api.libs.json.JsObject] and
        (__ \ "order_number").readNullable[String]
      )(Tracking.apply _)
    }
    ...
    implicit def jsonReadsApiWebhookDelivery: play.api.libs.json.Reads[WebhookDelivery] = {
      (
        (__ \ "id").read[String] and
        (__ \ "webhook").read[io.flow.v0.models.WebhookReference] and
        (__ \ "status").read[io.flow.v0.models.WebhookStatus] and
        (__ \ "created_at").read[_root_.org.joda.time.DateTime] and
        (__ \ "latest").readNullable[io.flow.v0.models.WebhookRequest] and
        (__ \ "next_attempt_at").readNullable[_root_.org.joda.time.DateTime]
      )(WebhookDelivery.apply _)
    }

    def jsObjectWebhookDelivery(obj: io.flow.v0.models.WebhookDelivery) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("latest" -> jsObjectWebhookRequest(x))
      }) ++
      (obj.nextAttemptAt match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("next_attempt_at" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(x)))
      })
    }

    implicit def jsonWritesApiWebhookDelivery: play.api.libs.json.Writes[WebhookDelivery] = {
      new play.api.libs.json.Writes[io.flow.v0.models.WebhookDelivery] {
        def writes(obj: io.flow.v0.models.WebhookDelivery) = {
          jsObjectWebhookDelivery(obj)
        }
      }
    }
    ...
    implicit def jsonReadsApiWebhookSettings: play.api.libs.json.Reads[WebhookSettings] = {
      (
        (__ \ "secret").readNullable[String] and
        (__ \ "retry_max_attempts").read[Long] and
        (__ \ "retry_sleep_ms").read[Long] and
        (__ \ "sleep_ms").read[Long]
      )(WebhookSettings.apply _)
    }

    def jsObjectWebhookSettings(obj: io.flow.v0.models.WebhookSettings) = {
      play.api.libs.json.Json.obj(
        "retry_max_attempts" -> play.api.libs.json.JsNumber(obj.retryMaxAttempts),
        "retry_sleep_ms" -> play.api.libs.json.JsNumber(obj.retrySleepMs),
        "sleep_ms" -> play.api.libs.json.JsNumber(obj.sleepMs)
      ) ++ (obj.secret match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("secret" -> play.api.libs.json.JsString(x))
      })
    }

    implicit def jsonWritesApiWebhookSettings: play.api.libs.json.Writes[WebhookSettings] = {
      new play.api.libs.json.Writes[io.flow.v0.models.WebhookSettings] {
        def writes(obj: io.flow.v0.models.WebhookSettings) = {
          jsObjectWebhookSettings(obj)
        }
      }
    }
        ...
        (js \ "discriminator").validate[String] match {
          ...
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              ...
              case "order_deleted" => js.validate[io.flow.v0.models.OrderDeleted]
              case "order_upserted" => js.validate[io.flow.v0.models.OrderUpserted]
              case "order_booking_deleted" => js.validate[io.flow.v0.models.OrderBookingDeleted]
              case "order_booking_upserted" => js.validate[io.flow.v0.models.OrderBookingUpserted]
              ...
              case "label_upserted" => js.validate[io.flow.v0.models.LabelUpserted]
              ...
              case "localized_item_snapshot" => js.validate[io.flow.v0.models.LocalizedItemSnapshot]
              ...
              case "authorization_upserted" => js.validate[io.flow.v0.models.AuthorizationUpserted]
              case "authorization_deleted" => js.validate[io.flow.v0.models.AuthorizationDeleted]
              case "capture_upserted" => js.validate[io.flow.v0.models.CaptureUpserted]
              case "card_upserted" => js.validate[io.flow.v0.models.CardUpserted]
              case "card_deleted" => js.validate[io.flow.v0.models.CardDeleted]
              case "refund_upserted" => js.validate[io.flow.v0.models.RefundUpserted]
    ...
    def jsObjectEvent(obj: io.flow.v0.models.Event) = {
      obj match {
        ...
        case x: io.flow.v0.models.OrderDeleted => jsObjectOrderDeleted(x) ++ play.api.libs.json.Json.obj("discriminator" -> "order_deleted")
        case x: io.flow.v0.models.OrderUpserted => jsObjectOrderUpserted(x) ++ play.api.libs.json.Json.obj("discriminator" -> "order_upserted")
        case x: io.flow.v0.models.OrderBookingDeleted => jsObjectOrderBookingDeleted(x) ++ play.api.libs.json.Json.obj("discriminator" -> "order_booking_deleted")
        case x: io.flow.v0.models.OrderBookingUpserted => jsObjectOrderBookingUpserted(x) ++ play.api.libs.json.Json.obj("discriminator" -> "order_booking_upserted")
        ...
        case x: io.flow.v0.models.LabelUpserted => jsObjectLabelUpserted(x) ++ play.api.libs.json.Json.obj("discriminator" -> "label_upserted")
        ...
        case x: io.flow.v0.models.LocalizedItemSnapshot => jsObjectLocalizedItemSnapshot(x) ++ play.api.libs.json.Json.obj("discriminator" -> "localized_item_snapshot")
        ...
        case x: io.flow.v0.models.AuthorizationUpserted => jsObjectAuthorizationUpserted(x) ++ play.api.libs.json.Json.obj("discriminator" -> "authorization_upserted")
        case x: io.flow.v0.models.AuthorizationDeleted => jsObjectAuthorizationDeleted(x) ++ play.api.libs.json.Json.obj("discriminator" -> "authorization_deleted")
        case x: io.flow.v0.models.CaptureUpserted => jsObjectCaptureUpserted(x) ++ play.api.libs.json.Json.obj("discriminator" -> "capture_upserted")
        case x: io.flow.v0.models.CardUpserted => jsObjectCardUpserted(x) ++ play.api.libs.json.Json.obj("discriminator" -> "card_upserted")
        case x: io.flow.v0.models.CardDeleted => jsObjectCardDeleted(x) ++ play.api.libs.json.Json.obj("discriminator" -> "card_deleted")
        case x: io.flow.v0.models.RefundUpserted => jsObjectRefundUpserted(x) ++ play.api.libs.json.Json.obj("discriminator" -> "refund_upserted")
    ...
    implicit def jsonReadsApiExportDelivery: play.api.libs.json.Reads[ExportDelivery] = new play.api.libs.json.Reads[ExportDelivery] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[ExportDelivery] = {
        (js \ "discriminator").validate[String] match {
          case play.api.libs.json.JsError(msg) => play.api.libs.json.JsError(msg)
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case "export_delivery_email" => js.validate[io.flow.v0.models.ExportDeliveryEmail]
              case other => play.api.libs.json.JsSuccess(io.flow.v0.models.ExportDeliveryUndefinedType(other))
            }
          }
        }
      }
    ...
    def jsObjectExportDelivery(obj: io.flow.v0.models.ExportDelivery) = {
      obj match {
        case x: io.flow.v0.models.ExportDeliveryEmail => jsObjectExportDeliveryEmail(x) ++ play.api.libs.json.Json.obj("discriminator" -> "export_delivery_email")
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesApiExportDelivery: play.api.libs.json.Writes[ExportDelivery] = {
      new play.api.libs.json.Writes[io.flow.v0.models.ExportDelivery] {
        def writes(obj: io.flow.v0.models.ExportDelivery) = {
          jsObjectExportDelivery(obj)
        }
      }
    }

    implicit def jsonReadsApiExportType: play.api.libs.json.Reads[ExportType] = new play.api.libs.json.Reads[ExportType] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[ExportType] = {
        (js \ "discriminator").validate[String] match {
          case play.api.libs.json.JsError(msg) => play.api.libs.json.JsError(msg)
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case "catalog_item_export_type" => js.validate[io.flow.v0.models.CatalogItemExportType]
              case "solidus_product_export_type" => js.validate[io.flow.v0.models.SolidusProductExportType]
              case "solidus_variant_export_type" => js.validate[io.flow.v0.models.SolidusVariantExportType]
              case other => play.api.libs.json.JsSuccess(io.flow.v0.models.ExportTypeUndefinedType(other))
            }
          }
        }
      }
    ...
    def jsObjectExportType(obj: io.flow.v0.models.ExportType) = {
      obj match {
        case x: io.flow.v0.models.CatalogItemExportType => jsObjectCatalogItemExportType(x) ++ play.api.libs.json.Json.obj("discriminator" -> "catalog_item_export_type")
        case x: io.flow.v0.models.SolidusProductExportType => jsObjectSolidusProductExportType(x) ++ play.api.libs.json.Json.obj("discriminator" -> "solidus_product_export_type")
        case x: io.flow.v0.models.SolidusVariantExportType => jsObjectSolidusVariantExportType(x) ++ play.api.libs.json.Json.obj("discriminator" -> "solidus_variant_export_type")
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesApiExportType: play.api.libs.json.Writes[ExportType] = {
      new play.api.libs.json.Writes[io.flow.v0.models.ExportType] {
        def writes(obj: io.flow.v0.models.ExportType) = {
          jsObjectExportType(obj)
        }
      }
    }
