 ...
 * User agent: apibuilder app.apibuilder.io/apicollective/apibuilder-spec/latest/play_2_x_scala_3_standalone_json
 */
package io.apibuilder.spec.v0.models {
  ...
  final case class Service(
    ...
    apidoc: _root_.scala.Option[io.apibuilder.spec.v0.models.Apidoc] = None,
    name: String,
    organization: io.apibuilder.spec.v0.models.Organization,
    application: io.apibuilder.spec.v0.models.Application,
    namespace: String,
